      ...
      <div className="ext-modal" onClick={(e) => e.stopPropagation()}>
        <div className="ext-header">
          <div className="ext-header-left">
            ...
            <div>
              <p className="ext-title">Finaliser ma commande</p>
              {product && <p className="ext-subtitle">{product.name} — {product.price} €</p>}
            </div>
          </div>
        ...
        <div className="ext-body">
          {iframeBlocked ? (
            <div className="ext-blocked">
              ...
              <h3>Commande par WhatsApp</h3>
              <p>
                Complétez votre commande directement via WhatsApp.<br />
              ...
              <div className="ext-blocked-actions">
                <a
                  href={`${WHATSAPP_URL}?text=${encodeURIComponent(`Bonjour, je souhaite commander : ${product?.name ?? 'une paire'} (${product?.price ?? ''}€)`)}`}
                  target="_blank"
